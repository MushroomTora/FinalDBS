...
<html lang="en">
    <head>
        ...
        <meta name="description" content="handmadetut.">
        <meta name="author" content="duongchunglinh">


        <!-- App title -->
        <title>HandemadeTutorials | Admin Panel</title>
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><h3>Handmade Tutorials</h3></span>
                                        </a>
                                    </h2>
